include("http://127.0.0.1/labyrinth/tmps/js/html5.js");
include("http://127.0.0.1/labyrinth/tmps/js/jquery.animate-colors-min.js");
include("http://127.0.0.1/labyrinth/tmps/js/jquery.backgroundpos.min.js");
include("http://127.0.0.1/labyrinth/tmps/js/jquery.easing.js");
include("http://127.0.0.1/labyrinth/tmps/js/superfish.js");
include("http://127.0.0.1/labyrinth/tmps/js/switcher.js");
include("http://127.0.0.1/labyrinth/tmps/js/bgStretch.js");
include("http://127.0.0.1/labyrinth/tmps/js/sImg.js");
include("http://127.0.0.1/labyrinth/tmps/js/forms.js");
include("http://127.0.0.1/labyrinth/tmps/js/jquery.tinyscrollbar.min.js");
include("http://127.0.0.1/labyrinth/tmps/js/MathUtils.js");
include("http://127.0.0.1/labyrinth/tmps/js/tinybox.js");
...
function hideSplash(){
    header.stop().animate({'top':'0px'},time,ease);
    footer.stop().animate({'bottom':'20px'},time,ease);
}

function showSplash(){
    header.stop().animate({'top':'250px'},time,ease);
    footer.stop().animate({'bottom':'150px'},time,ease);
}
...
function ON_LOAD(){
    ...
    $('.spinner').fadeOut();
     ...
     _val = 0;
    $("#page_login .overview div:even").each(function(ind,el){
        _val += $(el).outerHeight(true);
        $(this).parent().css({height:_val});
    });
	 _val =180;
    $("#page_topper  .overview div:even").each(function(ind,el){
        _val += $(el).outerHeight(true);
        $(this).parent().css({height:_val});
    });
	 $("#page_play .overview div:even").each(function(ind,el){
        _val += $(el).outerHeight(true);
        $(this).parent().css({height:_val});
    });
	   _val = 0;
    $("#page_blog .overview div:even").each(function(ind,el){
	 ...
	 _val = 1800;
    $("#page_comment .overview div:even").each(function(ind,el){
        _val += $(el).outerHeight(true);
        $(this).parent().css({height:_val});
    });
        
	$("#page_about .wrapper").tinyscrollbar({axis: 'y', sizethumb:"51", size:"331"});
	$("#page_topper  .wrapper").tinyscrollbar({axis: 'y', sizethumb:"51", size:"331"});
	$("#page_play .wrapper").tinyscrollbar({axis: 'y', sizethumb:"51", size:"331"});
	$("#page_blog .wrapper").tinyscrollbar({axis: 'y', sizethumb:"51", size:"331"});
	$("#page_login .wrapper").tinyscrollbar({axis: 'y', sizethumb:"51", size:"331"});
    $("#page_comment .wrapper").tinyscrollbar({axis: 'y', sizethumb:"51", size:"331"});
    //content switch
    header = $('header');
    footer = $('footer');
    content = $('#content');
